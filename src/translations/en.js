export default {
	...
	"keys": {
		...
		"businessCustomerAutoBusinessFeature_msg": "Note that the business feature will automatically be booked with all subscription plans for business customers.",
